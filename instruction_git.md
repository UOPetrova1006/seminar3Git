...
Ветки в Git позволяют создавать разные версии одного документа. Это используются для паралельной работы над одним проектом несколькими его участниками. Для создания ветки необходимо в терминале ввести команду:
